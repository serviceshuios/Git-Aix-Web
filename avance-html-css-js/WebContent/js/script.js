...
// querySelector
// retrouver un lien qui se trouve dans un paragraphe
var lien = document.querySelector("p a");
alert(lien.innerHTML);

// retrouver un élément par son id
var letitre = document.querySelector("#gros_titre");
alert(letitre.innerHTML);

//retrouver un élément par sa classe
var paragraphe = document.querySelector(".maClasse");
alert(paragraphe.innerHTML);

//querySelectorAll
var resultat = document.querySelectorAll(".maClasse");
for(i=0;i<resultat.length;i++){
	alert(resultat[i].innerHTML);
}
